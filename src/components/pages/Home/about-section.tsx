   ...
   return (
      <Grid container spacing={2} style={{ justifyContent: 'center', }}>
         ...
         <Grid item xs={12} sm={12} md={6} lg={6} xl={6} style={{ alignItems: isScreenSmall ? 'center' : 'normal', display: 'flex', flexDirection: 'column' }}>
            ...
            <Typography style={typo2} sx={{ textAlign: isScreenSmall ? "center" : 'normal' }}>
            Our web 2.0 has a wide range of services, including web design and development, tailor-made applications, ERPs,CRMs, e-commerce solutions, business-to-business applications, business-to-client applications, managed hosting, and internet portal management. Our Web 3.0 also has a wide range of services, including decentralized application development, blockchain development, and integration. Smart contract development, IoT integration, web 3.0 project management and implementation, and web 3.0 consulting and strategy development.
            </Typography>
            <Typography style={typo2} sx={{ textAlign: isScreenSmall ? "center" : 'normal' }}>
            We take pride in the quality of our work, and our satisfied clients around the world are a testament to our commitment to delivering exceptional services. As a technology leader, we are constantly exploring new avenues to expand our expertise and export quality software worldwide.
            </Typography>
