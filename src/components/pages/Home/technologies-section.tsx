...
const optionIcons = {
   Frontend: [<Frontend1 />, <Frontend2 />, <Frontend3 />, <Frontend4 />, <Frontend5 />, <Frontend6 />, <Frontend7 />, <Frontend8 />, <Frontend9 />],
   Backend: [<Backend1 />, <Backend2 />, <Backend3 />, <Backend4 />, <Backend5 />],
